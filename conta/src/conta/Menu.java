...
public class Menu 
{
	public static void main(String[] args) 
	{
		...
		System.out.println("\nCriar Contas\n");
		ContaCorrente cc1 = new ContaCorrente(contas.gerarNumero(), 123, 1, "João Claudino", 1000f, 100.0f);
		contas.cadastrar(cc1);
		
		ContaCorrente cc2 = new ContaCorrente(contas.gerarNumero(), 124, 1, "Marina Silva", 2000f, 100.0f);
		contas.cadastrar(cc2);
		
		ContaCorrente cp1 = new ContaCorrente(contas.gerarNumero(), 125, 2, "Helena Lima", 4000f, 12);
		contas.cadastrar(cp1);
		
		ContaCorrente cp2 = new ContaCorrente(contas.gerarNumero(), 126, 2, "Pedro Ramos", 8000f, 15);
		...
		while (true) 
		{
			...
			if (opcao == 9) 
			{
				System.out.println(Cores.TEXT_WHITE_BOLD + "\nBanco de SAMPA, O banco que entende você.");
				sobre();
				leia.close();
				System.exit(0);
			}
